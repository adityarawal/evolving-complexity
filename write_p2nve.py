                    ...
                    for param5 in np.arange(min_value,max_value,step_size):
                        for param6 in np.arange(min_value,max_value,step_size):
                            for param7 in np.arange(min_value,max_value,step_size):
                                param_str = str(param1)+'_'+str(param2)+'_'+str(param3)+'_'+str(param4)+'_'+str(param5)+'_'+str(param6)+'_'+str(param7)
                                ...
                                lines.append('recur_prob '+ str(param1)+'\n')
                                ...
                                lines.append('recur_only_prob '+ str(param7)+'\n')
